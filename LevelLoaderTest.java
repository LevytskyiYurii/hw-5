...
class LevelTooBigException extends Exception{
    ...
    public LevelTooBigException(String message, Throwable cause) {
        super(message, cause);
    }

    public LevelTooBigException(Throwable cause) {
        super(cause);
    }

    public LevelTooBigException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
